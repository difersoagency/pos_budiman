                ...
                <div class="col-lg-12">
                    ...
                    <div class="card tw-w-full tw-px-6 tw-py-5 tw-grid tw-grid-cols-1 md:tw-grid-cols-2 tw-items-center">
                        <div class="tw-w-full tw-col-span-2 md:tw-col-span-1">
                            <h1 class="tw-m-0 tw-text-2xl tw-font-bold">Laporan Retur Pembelian</h1>
...
<script>
    $(function(){
        ...
        function table(tgl_awal, tgl_akhir){
            ...
            $('#showtable').DataTable({
                ...
                "drawCallback": function ( settings ) {
                    ...
                    for (c = 0; c < columns.length; c++) {
                        api.column(columns[c], {
                            ...
                            class_style= c > 0 ? 'tw-bg-slate-500 tw-text-prim-white' : '';
                            if (last !== group) {
                                $(rows).eq(i).before(
                                    '<tr class="'+class_style+'" style=""><td colspan="7"><b>' + group +
                                    '</b></td></tr>'
                                );
                                last = group;
                            }
                ...
                ajax: {
                    'type': 'POST',
                    'datatype': 'JSON',
                    'url': '/laporan/table/retur_beli/'+tgl_awal+"/"+tgl_akhir,
                    'headers': {
        ...
        $(document).on('click', '#btnlaporan', function(){
            ...
            $('#btncetak').attr("href","/laporan/data/retur_beli/"+tgl_awal+"/"+tgl_akhir);
        })
