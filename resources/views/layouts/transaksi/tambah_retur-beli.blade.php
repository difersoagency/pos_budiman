...
<div class="content-wrapper tw-py-6 tw-px-5">
    <section class="tambahBeli">
        <form id="retur_beli" action="{{route('store-retur-beli')}}" method="POST">
            @csrf
        ...
        <button class="tw-w-48 tw-bg-prim-red tw-border-0  tw-text-center tw-text-white tw-py-2 tw-rounded-lg hover:tw-bg-red-700 tw-transition-all float-right" onclick="addrows('retur')" type="button">
            + Tambah Barang Retur
        </button>
        </div>
                        ...
                        <tr>
                            ...
                            <td class="tw-border-none">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control tw-w-1 tw-bg-transparent tw-border-transparent total" aria-label="Amount" id="total" name="total" value="0" >
                                </div>
                            </td>
                        </tr>
                    </tbody>
        ...
        <div class=" tw-mb-40 tw-mt-10">
            <button type="button"  onclick="location.href='/transaksi/retur-beli'" class="tw-bg-white tw-border-2 tw-mr-5 tw-text-prim-blue  tw-border-prim-blue hover:tw-bg-prim-blue hover:tw-text-prim-white  tw-w-32 tw-text-center tw-py-2 tw-rounded-lg  tw-transition-all">
