                    ...
                    <tbody id="tbody2">
                        <tr>
                            ...
                            <td data-label="Jumlah">
                                <div class="form-group">
                                    <input type="date" class="form-control" name="tanggal_bayar" disabled>
                                </div>
                            </td>
                            ...
                            <td data-label="Total">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" aria-label="Amount" id="jumlah_hutang" name="jumlah_hutang" value="0">
                                </div>
                            </td>
                            <td data-label="#">
