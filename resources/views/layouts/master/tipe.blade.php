            ...
            <div class="col-lg-12">
              <div class="card tw-w-full tw-px-6 tw-py-5 tw-grid tw-grid-cols-1 md:tw-grid-cols-2 tw-items-center">
                ...
                <div class="tw-text-right tw-items-center tw-grid tw-grid-cols-1 md:tw-grid-cols-2 tw-mx-auto md:tw-mx-0 md:tw-ml-auto tw-w-full md:tw-w-fit tw-mt-4 md:tw-mt-0">
                    <!-- START : Search Bar -->
                    <div class="search-bar tw-text-right items md:tw-ml-auto">
                        <input type="text" name="" id="" placeholder="Cari Tipe Produk" class="tw-bg-transparent tw-w-[90%] md:tw-w-[85%] tw-mb-4 md:tw-mb-0 tw-border-x-0 tw-border-t-0 tw-border-b-prim-blue tw-outline-none focus:tw-border-b-prim-red tw-transition-all">  
                ...
                <div class="table-barang-mobile tw-mt-5 md:tw-hidden">
                    <div class="list-barang" data-current-page="1">
                        <table class="table item-table">
                            <tbody>
                                <tr>
                                    <th scope="row" class="tw-bg-gray-100 tw-w-[50%]">Tipe</th>
                                    <td>Lampu Mobil</td>
                                </tr>
                                <tr>
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody class="tw-block tw-max-h-96 tw-w-full tw-overflow-y-scroll">
                            <tr class=" tw-w-full tw-table tw-table-fixed">
                                <td class="tw-px-3 tw-font-normal ">Lampu Mobil</td>
                            ...
                            <tr class=" tw-w-full tw-table tw-table-fixed">
                                <td class="tw-px-3 tw-font-normal ">Lampu Motor</td>
                            ...
                            <tr class=" tw-w-full tw-table tw-table-fixed">
                                <td class="tw-px-3 tw-font-normal ">Kaca Mobil</td>
