              ...
              <div class="card tw-w-full tw-px-6 tw-py-5 tw-grid tw-grid-cols-1 md:tw-grid-cols-2 tw-items-center">
                ...
                <div class="tw-text-right tw-items-center tw-grid tw-grid-cols-1 md:tw-grid-cols-2 tw-mx-auto md:tw-mx-0 md:tw-ml-auto tw-w-full md:tw-w-fit tw-mt-4 md:tw-mt-0">
                    ...
                    <div class="search-bar tw-text-right items">
                        <input type="text" name="" id="" placeholder="Cari Jasa" class="tw-bg-transparent tw-w-[90%] md:tw-w-[80%] tw-mb-4 md:tw-mb-0 tw-border-x-0 tw-border-t-0 tw-border-b-prim-blue tw-outline-none focus:tw-border-b-prim-red tw-transition-all">  
                ...
                <div class="table-barang-mobile tw-mt-5 md:tw-hidden">
                    <div class="list-barang" data-current-page="1">
                        <table class="table item-table">
                            <tbody>
                                <tr>
                                    <th scope="row" class="tw-bg-gray-100 tw-w-[50%]">Nama Jasa</th>
                                    <td>Ganti Kaca Mobil</td>
                                </tr>
                                <tr>
                                    <th scope="row" class="tw-bg-gray-100 tw-w-[50%]">Harga</th>
                                    <td>Rp.200.000</td>
                                </tr>
                                <tr class="tw-py-5">
                ...
                <div class="table-barang tw-mt-10 tw-col-span-2 tw-hidden md:tw-block">
                    <table class="table table-striped">
                        <thead class="tw-w-full tw-bg-prim-blue tw-table tw-table-fixed">
                            <tr class="">
                            <th class="tw-font-bold tw-px-3 tw-text-pri tw-border-b-prim-black tw-text-prim-white tw-border-t-0">Nama Jasa</th>
                            <th class="tw-font-bold tw-px-3 tw-text-pri tw-border-b-prim-black tw-text-prim-white tw-border-t-0">Harga</th>
                        ...
                        <tbody class="tw-block tw-max-h-96 tw-w-full tw-overflow-y-scroll">
                            <tr class=" tw-w-full tw-table tw-table-fixed">
                                <td class="tw-px-3 tw-font-normal ">Ganti Kaca Mobil</td>
                                <td class="tw-px-3">Rp. 200.000</td>
                                <td class="tw-px-3">
                            ...
                            <tr class=" tw-w-full tw-table tw-table-fixed">
                                <td class="tw-px-3 tw-font-normal ">Ganti Lampu Mobil</td>
                                <td class="tw-px-3">Rp. 50.000</td>
                                <td class="tw-px-3">
                                    <div class="grid grid-cols-2">
                                        <a href="" class="mr-4">
                                            <i class="fa fa-pen tw-text-prim-blue"></i>
                            ...
                            <tr class=" tw-w-full tw-table tw-table-fixed">
                                <td class="tw-px-3 tw-font-normal ">Ganti Velg</td>
                                <td class="tw-px-3">Rp. 750.000</td>
                                <td class="tw-px-3">
                                    <div class="grid grid-cols-2">
                                        <a href="" class="mr-4">
                                            <i class="fa fa-pen tw-text-prim-blue"></i>
