...
<script>
    ...
    $(document).ready(function() {
        ...
        $(document).on('submit', '#formtambah_jasa', function(event) {
            event.preventDefault();
            var action = $(this).attr('action');
            $.ajax({
                url: action,
                type: 'POST',
                data: $('#formtambah_jasa').serialize(),
                success: function(result) {
        ...
        $(document).on('submit', '#formedit_jasa', function(event) {
            event.preventDefault();
            var action = $(this).attr('action');
            $.ajax({
                url: action,
                type: 'POST',
                data: $('#formedit_jasa').serialize(),
                success: function(result) {
                    if (result.data == "success") {
                        Swal.fire({
                            title: 'Berhasil',
