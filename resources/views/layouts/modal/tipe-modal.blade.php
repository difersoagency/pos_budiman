    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Form Tipe Produk</h5>
            ...
            <div class="modal-body">
                <form>
                    <div class="form-group tw-mr-3">
                        <label for="kode-merk" class="col-form-label">Kode Tipe:</label>
                        <input type="text" class="form-control" id="kode-merk">
                    </div>

                    <div class="form-group tw-mr-3">
                        <label for="nama-merk" class="col-form-label">Nama Tipe:</label>
