<form action="{{ route('supplier.update', ['id' => $data->id]) }}" method="POST" id="formedit">
    @csrf
    ...
    <div class="form-group tw-mr-3">
        ...
        <input type="text" class="form-control" id="alamat_supplier" name="alamat" value="{{ $data->alamat }}">
    </div>
    ...
    <div class="modal-footer">
        ...
        <button type="submit" class="btn tw-bg-prim-blue tw-text-prim-white float-right">Save</button>
    </div>
</form>
