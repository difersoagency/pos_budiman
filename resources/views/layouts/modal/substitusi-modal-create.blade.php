<form method="POST" action="{{route('substitusi.store')}}" class="tw-h-96  tw-overflow-y-auto" id="formtambah">
    ...
    <div class="mx-2 mt-4">
        ...
        <div class="dropdown" style="width:100%;">
            <select class="custom-select sub_1 tw-text-prim-white select2" id="barang_id_1" name="barang_id_1">
                @foreach($barang as $b)
    ...
    <div class="mx-2 mt-4">
        ...
        <div class="dropdown" style="width:100%;">
            <select class="custom-select sub_2 tw-text-prim-white select2" id="barang_id_2" name="barang_id_2">
                @foreach($barang as $b)
                <option value="{{$b->id}}">{{$b->nama_barang}}</option>
                @endforeach
            </select>
