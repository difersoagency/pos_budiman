...
<div class="content-wrapper tw-py-8 tw-px-10">
    ...
    <section class="tw-mb-20">
        <div class="tw-grid md:tw-grid-cols-2 tw-gap-20 tw-gap-y-12 md:tw-gap-y-20">
            ...
            <button class='three lapbeli' onclick="location.href = '/laporan/pembelian'">Laporan Pembelian & Hutang</button>
            <button class='three lapbeli' onclick="location.href = '/laporan/pembelian'">Laporan Retur</button>
            @endif
