    ...
    <section class="login-sect tw-h-screen tw-w-screen tw-overflow-hidden">
        <div class="tw-grid tw-grid-cols-1 lg:tw-grid-cols-2 tw-h-screen md:tw-h-full ">
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="input-group mb-4">
                            <div class="input-group-append tw-bg-none mr-2">
                                <div
                                    class="input-group-text tw-bg-transparent tw-border-r-1 tw-border-y-0 tw-border-l-0 tw-border-red-500">
                                    <span class="fas fa-envelope tw-text-red-500 tw-bg-none"></span>
                                </div>
                            </div>
                            <input type="text" placeholder="Username" name="username"
                                class="bg-none form-control tw-border-x-0 tw-border-t-0 tw-border-b-1 focus:tw-border-b-2 focus:tw-border-red-500"
                                required autofocus>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-4">
                                <button type="submit"
                                    class="btn tw-bg-black btn-block tw-text-red-500 tw-font-bold hover:tw-bg-red">Masuk</button>
                            </div>
            ...
            <div class="login-img tw-hidden md:tw-block">
                <img src="{{ asset('assets/images/login-side.jpg') }}" alt="Image Login PT Maju Bersama Motor"
