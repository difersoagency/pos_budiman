    ...
    <section class="kasir-display">
        <div class="tw-flex">
            <div class="tw-flex-auto tw-w-96 tw-px-7 tw-py-6 tw-h-full">
                ...
                <div class="tw-grid tw-grid-cols-3 tw-mt-7 tw-gap-7">
                    <div class="item tw-px-3 tw-py-2 form-group">
                        ...
                        <button type="button" onclick="atcButton(this,'jumlah-kasir')" class="atc tw-mt-5 tw-border-transparent tw-px-3 tw-py-1 tw-w-full tw-bg-prim-blue hover:tw-bg-prim-black tw-transition-all disabled:tw-bg-gray-500">
                            <p class="tw-text-[12px] tw-m-0 tw-text-prim-white">Beli Barang</p>
                        </button>
                    </div>
                    <div class="item tw-px-3 tw-py-2 form-group">
                        <h3 class="tw-text-[16px] tw-font-bold tw-mt-4 nama-produk">Apaan tuh</h3>
                        <p class="tw-text-prim-red tw-font-bold tw-text-[14px] tw-m-0 tw-mt-1">Rp.<span class="harga-produk">1000</span></p>
                        <p class="tw-text-prim-black tw-text-[12px] tw-m-0 tw-mt-1 merk-produk">Merk Produk</p>
                        <div class="mt-2">
                            <div class="input-group">
                                <div class="input-group-prepend">
                                    <button type="button" onclick="minValueKasir('jumlah-kasir2')" class="min-btn w-outline-none tw-border-transparent tw-px-2 tw-bg-prim-red tw-text-prim-white">-</button>
                                </div>
                                <input type="text" class="form-control tw-w-4 tw-text-center" aria-label="Amount" id="jumlah-kasir2" value="0" name="stok">
                                <div class="input-group-prepend">
                                    <button type="button" onclick="addValueKasir('jumlah-kasir2')" class="plus-btn tw-bg-prim-red tw-text-prim-white tw-outline-none tw-border-transparent
                                        tw-px-2">+</button>
                                </div>
                            </div>
                        </div>
                        <button type="button" onclick="atcButton(this,'jumlah-kasir2')" class="atc tw-mt-5 tw-border-transparent tw-px-3 tw-py-1 tw-w-full tw-bg-prim-blue hover:tw-bg-prim-black tw-transition-all disabled:tw-bg-gray-500">
                            <p class="tw-text-[12px] tw-m-0 tw-text-prim-white">Beli Barang</p>
                        </button>
                    </div>
                </div>
            ...
            <div class="tw-flex-auto tw-w-1 tw-px-7 tw-py-6 tw-bg-prim-white tw-h-screen">
                <div class="tw-w-[-webkit-fill-available]">
                    <div>
                    ...
                    <div class="total-belanja tw-mb-12">
                        ...
                        <div class="tw-grid tw-grid-cols-2 bayar">
                            <p class="tw-font-bold">Bayar :</p>
                            <input type="number" class="form-control tw-w-20" aria-label="" id="diskon-kasir" name="bayar-kasir" placeholder="0" min="0">
                        </div>
                        <div class="tw-grid tw-grid-cols-2 bayar tw-mt-9">
                            <button class="tw-font-bold tw-border-transparent tw-bg-prim-red tw-text-prim-white tw-rounded-md tw-px-1 tw-py-2">Proses Pesanan</button>
                        </div>
                    </div>
                </div>
            </div>
