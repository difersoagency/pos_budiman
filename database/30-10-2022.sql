...
(2, 'BK/10/22/001', '2022-10-17', 1),
(3, 'BK/10/22/002', '2022-10-17', 1),
...
INSERT INTO `htrans_jual` (`id`, `no_trans_jual`, `promo_id`, `pembayaran_id`, `booking_id`, `tgl_trans_jual`, `total_jual`, `bayar_jual`, `kembali_jual`, `tgl_max_garansi`) VALUES
