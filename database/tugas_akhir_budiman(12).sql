...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 29, 2022 at 11:39 PM
...
(2, 1, 3, 1, 'ACCU-0192', 'Accu First Choice', 7, 500000, 540000);
...
INSERT INTO `dtrans_jual` (`id`, `htrans_jual_id`, `barang_id`, `jumlah`, `harga`, `disc`) VALUES
(3, 15, 2, 1, 540000, NULL);
...
INSERT INTO `dtrans_jual_jasa` (`id`, `htrans_jual_id`, `jasa_id`, `harga`, `disc`) VALUES
(2, 13, 2, 200000, NULL),
(3, 15, 1, 200000, NULL);
...
INSERT INTO `d_piutang` (`id`, `h_piutang_id`, `no_giro`, `tgl_piutang`, `total_bayar`) VALUES
(1, 3, NULL, '2022-11-06', 60000),
(2, 3, NULL, '2022-11-06', 60000);
...
(4, 15, 'RET/J/001/XI/22', '2022-11-30', 540000),
...
INSERT INTO `htrans_jual` (`id`, `no_trans_jual`, `no_giro`, `pembayaran_id`, `booking_id`, `tgl_trans_jual`, `total_jual`, `bayar_jual`, `kembali_jual`, `tgl_max_garansi`) VALUES
(13, 'TJ/X/22/0004', NULL, 2, 4, '2022-10-29', '200000', '20000', '0', '2022-11-29'),
(15, 'TJ/XI/22/0004', NULL, 1, 10, '2022-11-26', '740000', '550000', '0', '2023-01-07');
...
INSERT INTO `promo` (`id`, `kode_promo`, `tgl_mulai`, `tgl_selesai`, `nama_promo`, `barang_id`, `qty_sk`, `disc`) VALUES
(1, 'OLIPROMO14', '2022-11-01', '2023-02-04', 'Diskon Oli', 1, 2, '5'),
(2, 'AKIFIRST', '2022-11-01', '2022-12-01', 'Promo AKI', 2, 1, '5');
...
(1, 'nurul_a1', 2, 1, 'nurull@gmail.com', '2022-08-30 06:49:13', '$2y$10$Ktu04iC39Wu98QErXs5dlezFc5DmgAl0gCODUiaFHKjTVIay0ifKm', NULL, NULL, '2022-09-27 09:04:26'),
...
ALTER TABLE `dtrans_jual_jasa`
  ADD PRIMARY KEY (`id`),
  ADD KEY `jasa_id_dtrans_jual_jasa` (`jasa_id`),
  ADD KEY `htrans_jual_id_dtrans_jual_jasa` (`htrans_jual_id`);
...
--
ALTER TABLE `dtrans_jual_jasa`
  ADD CONSTRAINT `htrans_jual_id_dtrans_jual_jasa` FOREIGN KEY (`htrans_jual_id`) REFERENCES `htrans_jual` (`id`),
  ADD CONSTRAINT `jasa_id_dtrans_jual_jasa` FOREIGN KEY (`jasa_id`) REFERENCES `jasa` (`id`);
...
--
ALTER TABLE `d_piutang`
  ADD CONSTRAINT `h_piutang_piutang_id` FOREIGN KEY (`h_piutang_id`) REFERENCES `h_piutang` (`id`);
