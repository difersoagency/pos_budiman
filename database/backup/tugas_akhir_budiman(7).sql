...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 20, 2022 at 06:29 PM
...
INSERT INTO `pegawai` (`id`, `kode_pegawai`, `nama_pegawai`, `gender`, `telepon`, `email`) VALUES
(1, 'a001', 'nurul', 'L', NULL, NULL),
(2, 'a002', 'tutik', 'L', NULL, NULL),
(3, 'k001', 'fian', 'L', NULL, NULL),
(4, 'o001', 'hasan', 'L', NULL, NULL);
